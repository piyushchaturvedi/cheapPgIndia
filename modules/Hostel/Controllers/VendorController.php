...
class VendorController extends FrontendController
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Manage Hostels"),
        ];
        return view('Hostel::frontend.vendorHotel.index', $data);
    }
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Recovery Hostels"),
        ];
        return view('Hostel::frontend.vendorHotel.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('Hostel::frontend.vendorHotel.detail', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('hostel.vendor.index'))->with('warning', __('Space not found!'));
        }
    ...
    public function delete($id)
    {
        ...
        return redirect(route('hostel.vendor.index'))->with('success', __('Delete hotel success!'));
    }
    ...
    {
        $data = [
            'bookings' => $this->bookingClass::getBookingHistory($request->input('status'), false , Auth::id() , 'hostel'),
            'statues'  => config('booking.statuses'),
            'breadcrumbs'        => [
                [
                    'name' => __('Manage Hostel'),
                    'url'  => route('hostel.vendor.index')
                ],
                [
        ...
        return view('Hostel::frontend.vendorHotel.bookingReport', $data);
    }
