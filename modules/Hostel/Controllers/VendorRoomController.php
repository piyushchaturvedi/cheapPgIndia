...
use Modules\Hostel\Models\HotelRoom;
use Modules\Hostel\Models\HotelRoomTerm;
use Modules\Hostel\Models\HotelRoomTranslation;
use Modules\Location\Models\Location;
use Modules\Hostel\Models\Hotel;
use Modules\Hostel\Models\HotelTerm;
...
class VendorRoomController extends FrontendController
{
    ...
    public function store( Request $request, $hotel_id,$id ){
        ...
        if($id>0){
            ...
            $row = $this->roomClass::find($id);
            if (empty($row)) {
                return redirect(route('hostel.vendor.index'));
            }
