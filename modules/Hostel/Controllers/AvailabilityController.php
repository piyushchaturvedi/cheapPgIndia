...
use Modules\Hostel\Models\HotelRoomBooking;
use Modules\Hostel\Models\HotelRoomDate;
...
class AvailabilityController extends FrontendController{
    ...
    protected $indexView = 'Hostel::frontend.user.availability';
    ...
    public function index(Request $request,$hotel_id){
        ...
        $breadcrumbs = [
            ...
            [
                ...
                'url'  => route('hostel.vendor.edit',[$this->currentHotel->id])
            ],
            [
    ...
    public function loadDates(Request $request,$hotel_id){
        ...
        if(!$this->hasHotelPermission($hotel_id))
        {
            return $this->sendError(__("Hostel not found"));
        }
        /**
         * @var $room HotelRoom
         */
