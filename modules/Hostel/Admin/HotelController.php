...
class HotelController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'=>__("Hostel Management")
        ];
        return view('Hostel::admin.index', $data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            'row'            => $row,
            'attributes'     => $this->attributesClass::where('service', 'hostel')->get(),
            ...
            'page_title'     => __("Add new Hostel")
        ];
        return view('Hostel::admin.detail', $data);
    }
    ...
    public function recovery(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'=>__("Recovery Hostel Management")
        ];
        return view('Hostel::admin.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('hostel.admin.index'));
        }
    ...
    public function store( Request $request, $id ){
        if($id>0){
            ...
            if($row->create_user != Auth::id() and !$this->hasPermission('hostel_manage_others'))
            {
                return redirect(route('hostel.admin.index'));
            }
        }else{
            $this->checkPermission('hostel_create');
            $row = new $this->hotelClass();
            $row->status = "publish";
        }
        $dataKeys = [
            ...
            'discounted_price',
            'condition_for_corporate_booking',
            'contact',
            'owner',
            'deposit_amount'
        ];
        if($this->hasPermission('hostel_manage_others')){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                return back()->with('success',  __('Hostel updated') );
            }else{
                return redirect(route('hostel.admin.edit',$row->id))->with('success', __('Hostel created') );
            }
        }
    }
    ...
    {
        $this->checkPermission('hostel_manage_attributes');
