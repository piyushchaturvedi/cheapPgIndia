...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'hostel');
        ...
        return view('Hostel::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('Hostel::admin.attribute.detail', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/hostel/attribute/terms/' . $row->attr_id
                ],
                [
