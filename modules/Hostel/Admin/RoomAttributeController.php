...
class RoomAttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Hostel::admin.room.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('Hostel::admin.room.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Hostel::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => 'admin/module/hostel/room/attribute/terms/' . $row->attr_id
                ],
                [
        ...
        return view('Hostel::admin.terms.detail', $data);
    }
