    ...
    public function index(Request $request,$hotel_id)
    {
        ...
        $data = [
            ...
            'breadcrumbs'        => [
                ...
                [
                    'name' => __('Hostel: :name',['name'=>$this->currentHotel->title]),
                    'url'  => 'admin/module/hostel/edit/'.$this->currentHotel->id
                ],
                [
        ...
        return view('Hostel::admin.room.index', $data);
    }
    ...
    public function edit(Request $request, $hotel_id,$id)
    {
        ...
        $data = [
            ...
            'breadcrumbs'    => [
                ...
                [
                    'name' => __('All Rooms'),
                    'url'  => 'admin/module/hostel/room/'.$this->currentHotel->id.'/index'
                ],
                [
                    'name' => __('Edit room: :name',['name'=>$row->title]),
                    'url'  => 'admin/module/hostel/room/'.$this->currentHotel->id.'/edit/'.$id
                ],
            ],
            'page_title'=>__("Edit: :name",['name'=>$row->title]),
            'hotel'=>$this->currentHotel
        ];
        return view('Hostel::admin.room.detail', $data);
    }
