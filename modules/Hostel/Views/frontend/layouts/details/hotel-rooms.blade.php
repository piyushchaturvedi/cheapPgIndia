<div id="hotel-rooms" class="hotel_rooms_form" v-cloak="" :class="{'d-none':enquiry_type!='book'}">
    ...
    <div class="nav-enquiry" v-if="is_form_enquiry_and_book">
        ...
        <div class="enquiry-item" data-toggle="modal" data-target="#enquiry_form_modal">
            <span>{{ __("Enquiry For Carporate Booking") }}</span>
        </div>
    </div>
    <div class="form-book">
                ...
                <div class="col-md-3">
                    <div class="form-group form-date-field form-date-search ">
                        ...
                        <label class="form-label">{{__("Start Date")}}</label>
                            <input type="date" name="start_date" id="start_date" min="{{date('Y-m-d')}}" max="{{date('Y-m-d', strtotime("+1 years"))}}" class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group form-date-field form-date-search ">
                        ...
                        <input type="date" name="end_date" id="end_date" min="{{date('Y-m-d', strtotime("+1 month"))}}"  class="form-control end_date">
                    </div>
                </div>
                {{-- <div class="col-md-3">
...
@include("Booking::frontend.global.enquiry-form",['service_type'=>'hostel'])
