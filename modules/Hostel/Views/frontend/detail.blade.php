...
@section('content')
    <div class="bravo_detail_hotel">
        @include('Hostel::frontend.layouts.details.hotel-banner')
        <div class="bravo_content">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-9">
                        @php $review_score = $row->review_data @endphp
                        @include('Hostel::frontend.layouts.details.hotel-detail')
                        @include('Hostel::frontend.layouts.details.hotel-review')
                    </div>
                    <div class="col-md-12 col-lg-3">
                        @include('Hostel::frontend.layouts.details.hotel-form-enquiry')
                        @include('Hostel::frontend.layouts.details.hotel-related-list')
        ...
        @include('Hostel::frontend.layouts.details.hotel-form-enquiry-mobile')
    </div>
@endsection
