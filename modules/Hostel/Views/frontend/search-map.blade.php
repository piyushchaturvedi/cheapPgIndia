...
@section('content')
    <div class="bravo_search_tour bravo_search_space">
        ...
        <div class="bravo_form_search_map">
            @include('Hostel::frontend.layouts.search-map.form-search-map')
        </div>
        <div class="bravo_search_map">
            ...
            <div class="results_item">
                @include('Hostel::frontend.layouts.search-map.advance-filter')
                <div class="listing_items">
                    @include('Hostel::frontend.layouts.search-map.list-item')
                </div>
            </div>
        </div>
    </div>
