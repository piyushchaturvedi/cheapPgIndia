    ...
    <div class="panel">
        ...
        <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Hostel Rent")}}">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="control-label">{{__("Sale Price")}}</label>
                            <input type="number" step="any" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Discount Rent Price")}}">
                            <span><i>{{__("If the regular price is less than the discount , it will show the regular price")}}</i></span>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                            <label class="control-label">{{__("Deposit Amount")}}</label>
                            <input type="text" name="deposit_amount" class="form-control" value="{{$row->deposit_amount}}" placeholder="{{__("Deposit Amount")}}">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group @if(!is_default_lang()) d-none @endif">
                        <label><input type="checkbox" name="is_corporate_booking" @if(!empty($row->is_corporate_booking)) checked @endif value="1"> {{__('Enable for Corporate Booking')}}
                        </label>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select name="extra_price[{{$key}}][type]" class="form-control" @if(!is_default_lang()) disabled @endif>
                                            ...
                                            <option @if($extra_price['type'] ==  'per_month') selected @endif value="per_month">{{__("Per month")}}</option>
                                        </select>
                                        <label>
            ...
            <div class="form-group-item @if(!is_default_lang()) d-none @endif" data-condition="is_corporate_booking:is(1)">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group @if(!is_default_lang()) d-none @endif">
                            <label class="control-label">{{__("Discount Percent")}}</label>
                            <input type="number" class="form-control" name="discounted_price" placeholder=" {{__('Discount Percent')}}" value="{{$row->discounted_price}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group @if(!is_default_lang()) d-none @endif">
                            <label class="control-label">{{__("Condition for Corporate Booking")}}</label>
                            <input type="number" class="form-control" name="condition_for_corporate_booking" placeholder="{{__('Enter Number of Rooms for booking')}}" value="{{$row->condition_for_corporate_booking}}">
                        </div>
                    </div>
                </div>
