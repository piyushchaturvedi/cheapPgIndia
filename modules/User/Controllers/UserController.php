...
class UserController extends FrontendController
{
    ...
    public function agreement(Request $request)
    {
        ...
        return view('User::frontend.agreement', $data);
    }
    ...
    public function loginWithOTP(Request $request)
    {
        ...
        {
            $data['status_code']=1;
            $data['message']='Enter OTP';
            //return redirect()->back()->with('error', __('Enter OTP'));
        }
    ...
    function send_otp(Request $request)
    {
        ...
        if(!empty($user))
        {
            $msg=urlencode("Dear ".$user->name. " You OTP for login is ".$rand);
