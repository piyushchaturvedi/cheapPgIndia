        ...
        <div class="container-fluid">
            <div class="row mt-3" >
                ...
                <div class="col-md-7 col-lg-7 pr-5 pl-5 fixheight"  id="printableArea">
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <p class="col-form-label" id="guest_name">{{$user->name}}</p>
                              </div>
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <p class="col-form-label" id="p_address">{{$user->address.' '.$user->address2}}</p>
                                </div>
                              </div>
                              <div class="form-group row">
                    ...
                    <p>
                        ...
                        <span id="guest_name2">{{$user->name}}</span> hereinafter referred to as "the Paying Guest" of the Second Part;
            ...
            <div class="col-md-5 col-lg-5 pr-5 pl-5 fixheight">
                <p class="text-center mt-5 mb-3">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" id="guest_name" placeholder="Guest Name" value="{{$user->name}}">
                    </div>
                    {{-- <div class="form-group">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" id="guest_address" placeholder="Guest Address" value="{{$user->address.' '.$user->address2}}">
                    </div>
                    {{-- <div class="form-group">
                    ...
                    {{-- <div class="totalFees">
                        Total Fees : <i class="fa fa-inr" aria-hidden="true"></i> 1000
                    </div> --}}
                    <div class="text-center">
