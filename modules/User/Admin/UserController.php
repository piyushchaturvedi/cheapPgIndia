...
class UserController extends AdminController
{
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($row->save()) {
            ...
            $msg=urlencode("Dear ".$row->name. " You have successfully registered and your username  ".$row->email." and password is ".$request->input('password'));
            
            $ch = curl_init("http://bulksms.webstag.net/rest/services/sendSMS/sendGroupSms?AUTH_KEY=3cdeb6689249ecdb4fa721b2438141fd&message=$msg&senderId=DEMOOS&routeId=3&mobileNos=".$row->phone."&smsContentType=english");
    ...
    public function testMail()
    {
        ...
        Mail::send('User::admin.email', ['user' => 'kapil.cloud18@gmail.com'], function ($m) {
             $m->from('test@cloud18.info', 'C-18');
            $m->to('kapil.cloud18@gmail.com', 'Amit')->subject('Your Reminder!');
            $m->to('amitlko656@gmail.com', 'Amit')->subject('Your Reminder!');
        });
        echo 'success';
    }
}
