    ...
    <div class="container-fluid">
        <div class="content row">
            <div class="header-left">
                <a href="{{url(app_get_locale(false,'/'))}}" class="bravo-logo col-md-2 text-center" >
                    @if($logo_id = setting_item("logo_id"))
                        <?php $logo = get_file_url($logo_id,'full') ?>
                        <img src="{{$logo}}" alt="{{setting_item("site_title")}}" width="150px">
                    @endif
                </a>
                <div class="bravo-menu col-md-10" style="padding-left: 0 !important;">
